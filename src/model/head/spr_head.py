...
class SPRHead(BaseHead):
    ...
    def __init__(self,
        ...
        print(f"Initializing SPRHead with in_dim: {self.in_dim}, num_heads: {self.num_heads}, num_predictions: {self.num_predictions}, num_actions: {self.num_actions}, action_size: {self.action_size}")
    ...
    def forward(self, x, act=None, idx=None):
        ...
        # Transition
        x_t, _ = self.transition(action_embed, x) # (n, t, d)
